    ...
    public partial class Form1 : Form
    {
        ...
        private void _gameTimer_Tick(object sender, EventArgs e)
        {
            ...
            if ((_food != null) && (Snake.CanEatFood(_food)))
            {
                ...
                _lbl.Text = string.Format("Score: {0}", _score);
            }
            else
            {
                _lbl.Text = string.Format("Score: {0}", _score);
                ...
                if (Snake.HitSelf())
                {
                    _failMessage = "Fail! Crashed into Self.";
                    _fail = true;
                    _gameTimer.Stop();
                ...
                {
                    _failMessage = "Fail! Crashed into Wall.";
                    _fail = true;
                    _gameTimer.Stop();
